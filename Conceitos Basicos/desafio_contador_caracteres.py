...
def contadorCaracteres(texto):
    countVogalA = texto.lower().count('a')
    countVogalE = texto.lower().count('e')
    countVogalI = texto.lower().count('i')
    countVogalO = texto.lower().count('o')
    countVogalU = texto.lower().count('u')

    print(f'No seu texto, contem a seguinte quantidade de vogais: \n Vogais A = {countVogalA} \n Vogais E = {countVogalE}\n Vogais I = {countVogalI} \n Vogais O = {countVogalO} \n Vogais U = {countVogalU}')
